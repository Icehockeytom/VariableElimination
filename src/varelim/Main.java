...
public class Main
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        for (Table t : Ps)
        {
            ...
            Ps2.add(new Table2(new Table(t.getTable(), headers), writer));
        }
...
//        }
    ...
    public static Table2 variableElimination(ArrayList<Variable> Vs, ArrayList<Table2> Ps, ArrayList<Variable> O, Variable Q, BufferedWriter writer, Networkreader reader) throws IOException
    {
        ...
        /**
         * Check if variables are observed and if so, filter them out of all
         * tables with coherence
         */
        for (Variable X : Vs)
        {
        ...
        return new Table2(new Table(newRows, query.getHeaders()), writer);
    }
